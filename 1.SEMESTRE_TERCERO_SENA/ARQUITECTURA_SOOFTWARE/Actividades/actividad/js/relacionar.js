$(function() {
            ...
            if(li.length < 1) {
                ...
                ui.draggable.fadeOut(function() {
                    ...
                    if(idR==idQ) {
                        ...
                        $('#personaje_cara').removeClass('default').addClass('gano');
                    }else {
                        invalidas++;
                        $('#concepto'+idQ+'_r').addClass('mala');
                        $('.c'+idQ).addClass('perdio');
                        if(conaudio<2) $('audio')[2].play();
                        $('#personaje_cara').removeClass('default').addClass('perdio');
                    }
                    ...
                    setTimeout(function() {
                        ...
                        $('audio')[1].load();
                        $('audio')[2].load();
                        $('#personaje_cara').removeClass('gano perdio').addClass('default');
                    }, 2000);
    ...
    function verificar() {
        ...
        $('#personaje_cara').hide();
        $('#personaje_cuerpo').hide();
        $('#instrucciones_bottom').hide();
        $('.instrucciones').hide();

        $('.bt__jugar-de-nuevo').show();
